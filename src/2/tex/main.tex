...
\salign{t = bx,\quad \df x = \frac{1}{b}\df t,\quad I(a, b) = \int\limits_0^\infty e^{-ax} \frac{\sin^2{bx}}{x^2}\; \df x = b \int\limits_0^\infty e^{-\frac{a}{b}t} \frac{\sin^2{t}}{t^2}\; \df t.}
...
\salign{I(a,b) = b \int\limits_0^\infty e^{-\frac{a}{b}t} \frac{\sin^2{t}}{t^2}\; \df t \approx b \int\limits_0^\infty e^{-\frac{a}{b}t} \frac{t^2}{t^2}\; \df t = \frac{b^2}{a} \int\limits_0^\infty e^{-\frac{a}{b}t}\; \df \left(\frac{a}{b}t\right) = \frac{b^2}{a},}
ответ:
...
\salign{e^{-\frac{a}{b}t} \approx 1,\ I(a, b) = b \int\limits_0^\infty e^{-\frac{a}{b}t} \frac{\sin^2{t}}{t^2}\; \df t \approx b \int\limits_0^\infty \frac{\sin^2{t}}{t^2}\; \df t.}
Полученный интеграл вычисляется:
\salign{
  \begin{aligned}
    I &= \int\limits_0^\infty \frac{\sin^2{t}}{t^2}\; \df t = \left.\frac{\sin^2{t}}{t}\right|_0^\infty - \int\limits_0^\infty t\; \df \left(\frac{\sin^2{t}}{t^2}\right) = - \int\limits_0^\infty t\; \df \left(\frac{\sin^2{t}}{t^2}\right)\\
      &= - \int\limits_0^\infty t \left(\frac{2\sin{t}\cos{t}}{t^2} - \frac{2\sin^2{t}}{t^3}\right)\; \df t = - \int\limits_0^\infty \frac{\sin{2t}}{2t}\; \df (2t) + 2I,\quad I = \int\limits_0^\infty \frac{\sin{2t}}{2t}\; \df (2t) = \frac{\pi}{2},
  \end{aligned}
}
ответ:
...
\salign{
  \begin{aligned}
    I(a, b) = \int\limits_0^\infty \frac{1}{x^2 + a^2} \frac{1}{(x-1)^2 + b^2}\; \df x \approx  \frac{1}{1 + b^2}\int\limits_0^\infty \frac{1}{x^2 + a^2}\; \df x &= \left.\frac{1}{1+b^2} \frac{1}{a} \arctg{\frac{x}{a}}\right|_0^\infty = \\
                                                                                                                                            &= \frac{\pi}{2a(1 + b^2),}
  \end{aligned}
}
ответ:
...
\salign{I(a) = \int\limits_0^\infty \frac{1}{x^2 + a^2} \frac{1}{(x-1)^2 + a^2}\; \df x \approx \int\limits_0^\infty \frac{1}{(x^2 + a^2)^2}\; \df x.}
...
\salign{
  \begin{aligned}
    a \gg 1 &\Rightarrow \forall x \le \infty, x \ge 0 \hookrightarrow \frac{1}{\left((x-1)^2 + a^2\right)^2} \ge \frac{1}{x^2 + a^2} \frac{1}{(x-1)^2 + a^2} \ge \frac{1}{\left(x^2 + a^2\right)^2} > 0,\\
          &\implies \int\limits_0^\infty \frac{1}{\left((x-1)^2 + a^2\right)^2}\; \df x \ge \int\limits_0^\infty \frac{1}{x^2 + a^2} \frac{1}{(x-1)^2 + a^2}\; \df x \ge \int\limits_0^\infty \frac{1}{\left(x^2 + a^2\right)^2}\; \df x,
  \end{aligned}
}
а следовательно, если выполняется
\salign{I_1 = \int\limits_0^\infty \frac{1}{\left(x^2 + a^2\right)^2}\; \df x \approx \int\limits_0^\infty \frac{1}{\left((x-1)^2 + a^2\right)^2}\; \df x = \int\limits_{-1}^{\infty} \frac{1}{\left(x^2 + a^2\right)^2}\; \df x = I_2,}
что равносильно
...
откуда:
\salign{I_1 = \int\limits_0^\infty \frac{1}{\left(x^2 + a^2\right)^2}\; \df x = \frac{\pi}{4a^3},\quad I_2 = \int\limits_{-1}^\infty \frac{1}{\left(x^2 + a^2\right)^2}\; \df x = \frac{\pi}{4a^3} + \frac{1}{2a^3} \left(\frac{a}{a^2 + 1} + \arctan{\frac{1}{a}}\right).}
