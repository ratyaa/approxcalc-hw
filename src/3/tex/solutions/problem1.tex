...
\feq{I(\lambda) \approx e^{f(\hat{x})} \sqrt{\frac{2\pi}{|f''(\hat{x})|}} + e^{f(-\hat{x})} \sqrt{\frac{2\pi}{|f''(-\hat{x})|}} \approx \frac{e^{\frac14 \lambda^2}\sqrt{\pi}}{2^{\lambda - 1}},}
ответ:
\falign{\boxed{I(\lambda) \approx \frac{e^{\frac14 \lambda^2}\sqrt{\pi}}{2^{\lambda - 1}}}}
