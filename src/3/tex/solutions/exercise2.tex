...
тогда, так как
\feq{\tilde{f}''(x) = -\left[8x^2 + 2\left((x-1)^2 + (x-2)^2\right)\right],\quad \tilde{f}''(x_1) = -10 \sim 1,\quad \tilde{f}''(x_2) = -34 \sim 1}
...
ответ:
\feq{\boxed{I(\lambda) = \sqrt{\frac{2\pi}{\lambda}}\left(\frac{1}{\sqrt{10}} + \frac{1}{\sqrt{34}}\right)}}