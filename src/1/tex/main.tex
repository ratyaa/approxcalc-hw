...
В грубом приближении $\tanh{\alpha\tilde{x}_1} \approx 1, \ \tilde{x}_1 \approx \frac{\pi}{4}$, а следовательно $\varepsilon \ll 1$.
...
\salign{\boxed{\tilde{x} \in \left\{0, \ \beta - \frac{\beta^2 + 1}{e^{2\alpha\beta} + 1}, \ -\beta + \frac{\beta^2 + 1}{e^{2\alpha\beta} + 1}\right\}}}
